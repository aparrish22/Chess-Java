...
public class King extends Piece {
    ...
    // image
    File whitePath = new File("resources/images/W-King.png");
    File blackPath = new File("resources/images/B-King.png");

    public King(Color color, String side) {
        name = "Pawn";
        this.shortName = "";
        this.color = color;
        this.side = side;
